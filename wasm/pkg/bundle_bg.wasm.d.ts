...
export function __wbg_networkgenerated_free(a: number): void;
export function networkgenerated_encode_secrets(a: number): number;
export function networkgenerated_encode_proofs(a: number): number;
export function networkgenerated_encode_total(a: number): number;
