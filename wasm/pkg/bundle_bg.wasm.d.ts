...
export function generator_new(a: number, b: number, c: number, d: number): number;
export function generator_generate(a: number): number;
export function __wbg_generated_free(a: number): void;
export function generated_encode_secrets(a: number): number;
export function generated_encode_proofs(a: number): number;
export function generated_encode_total(a: number): number;
