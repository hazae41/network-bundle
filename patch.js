...
const wasm = readFileSync("./wasm/pkg/bundle_bg.wasm")

writeFileSync(`./wasm/pkg/bundle.wasm.js`, `export const data = "data:application/wasm;base64,${wasm.toString("base64")}";`);
writeFileSync(`./wasm/pkg/bundle.wasm.d.ts`, `export const data: string;`);
...
const glueJs = readFileSync(`./wasm/pkg/bundle.js`, "utf8")
  .replace("async function __wbg_init", "export async function __wbg_init")
  .replace("input = new URL('bundle_bg.wasm', import.meta.url);", "throw new Error();")
  .replaceAll("  free() {", disposableJs)
  .replaceAll(beforeMemoryJs, afterMemoryJs)

const glueTs = readFileSync(`./wasm/pkg/bundle.d.ts`, "utf8")
...
writeFileSync(`./wasm/pkg/bundle.js`, glueJs)
writeFileSync(`./wasm/pkg/bundle.d.ts`, glueTs)
